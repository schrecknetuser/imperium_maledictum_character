                    ...
                    VStack(spacing: 0) {
                        ...
                        HStack(spacing: 0) {
                            ...
                            Text("Total")
                                .font(.caption)
                                .fontWeight(.medium)
                                .frame(width: geometry.size.width * 0.14, alignment: .center)
                        }
                        .padding(.horizontal)
                        .padding(.vertical, 8)
                    ...
                    VStack(spacing: 0) {
                        ...
                        HStack(spacing: 0) {
                            ...
                            Text("Char.")
                                .font(.caption)
                                .fontWeight(.medium)
                                .frame(width: geometry.size.width * 0.10, alignment: .center)
                            Text("Adv.")
                                .font(.caption)
                                .fontWeight(.medium)
                                .frame(width: geometry.size.width * 0.14, alignment: .center)
                    ...
                    VStack(spacing: 0) {
                        ...
                        HStack(spacing: 0) {
                            ...
                            Text("Skill")
                                .font(.caption)
                                .fontWeight(.medium)
                                .frame(width: geometry.size.width * 0.18, alignment: .center)
                            Text("Adv.")
                                .font(.caption)
                                .fontWeight(.medium)
                                .frame(width: geometry.size.width * 0.14, alignment: .center)
